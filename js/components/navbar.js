...
class GlobalNavbar {
    ...
    getCurrentPageName() {
        ...
        // Si está en la raíz o index.html
        if (fileName === '' || fileName === 'index.html') return 'inicio';
        if (fileName === 'certificados.html') return 'certificados';
        if (fileName === 'crud.html') return 'gestion';
            ...
            <div class="max-w-7xl mx-auto">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden sm:flex items-center space-x-4">
                        ${this.getNavButton('inicio', 'index.html', 'fa-home', 'Inicio', 'indigo')}
                        ${this.getNavButton('certificados', 'certificados.html', 'fa-file-alt', 'Certificados', 'emerald')}
                        ${this.getNavButton('gestion', 'crud.html', 'fa-database', 'Gestión de Datos', 'blue')}
                ...
                <div id="mobileMenu" class="hidden sm:hidden mt-4 pb-4 border-t border-gray-200">
                    <div class="flex flex-col space-y-2 pt-4">
                        ${this.getMobileNavButton('inicio', 'index.html', 'fa-home', 'Inicio')}
                        ${this.getMobileNavButton('certificados', 'certificados.html', 'fa-file-alt', 'Certificados')}
                        ${this.getMobileNavButton('gestion', 'crud.html', 'fa-database', 'Gestión de Datos')}
